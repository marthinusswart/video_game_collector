...
class AddGameForm(FlaskForm):
    ...
    sort_title = StringField('Sort Title', validators=[Length(min=0, max=100)],
                             render_kw={
        'class': 'form-control', 'aria-describedby': 'game-sort-title-text'})

    series = StringField('Series', validators=[Length(min=0, max=100)],
        render_kw={'class': 'form-control', 'aria-describedby': 'series-text'})

    igdb_text = StringField('igdb text', validators=[Length(min=0, max=10)], render_kw={'class': 'form-control', 'aria-describedby': 'igdb-id-text'})
    ...
    description = TextAreaField('Description', validators=[InputRequired(), Length(max=200)],
                                render_kw={'class': 'form-control', 'aria-describedby': 'description-text'})

    condition_id = SelectField('Condition', coerce=int,
                               render_kw={'class': 'form-select', 'aria-describedby': 'condition-text'})
    ...
    genre_id = SelectField('Genre', coerce=int,
                               render_kw={
                                   'class': 'form-select', 'aria-describedby': 'genre-text'})
...
class DetailViewGameForm(FlaskForm):
    title = StringField('Title longer title', validators=[InputRequired(),
                                                          Length(min=5, max=100)],
                        render_kw={
                        'class': 'form-control', 'aria-describedby': 'game-title-text'})
...
class AddPublisherForm(FlaskForm):
    publisher_name = StringField('Name', validators=[InputRequired(), Length(min=3, max=100)],
                                 render_kw={
        'class': 'form-control'})


class AddDeveloperForm(FlaskForm):
    developer_name = StringField('Name', validators=[InputRequired(), Length(min=3, max=100)],
...
class AddGenreForm(FlaskForm):
    genre_name = StringField('Name', validators=[InputRequired(), Length(min=3, max=100)],
        render_kw={'class': 'form-control'})